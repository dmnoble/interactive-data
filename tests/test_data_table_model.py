from src.models.data_table_model import DataTableModel
from src.controllers.undo_controller import Action
...
@patch("src.models.data_table_model.DataTableModel.load_undo_stack_from_file")
@patch("src.models.data_table_model.DataTableModel.replay_undo_stack")
